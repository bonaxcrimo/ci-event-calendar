...
<script>
  ...
  function view(roleid){
    page='<?php echo base_url(); ?>roles/view/'+roleid;
    $.ajax({
        type: "GET",
        url: page,
        dataType: 'html',
        success: function(res) {
            $('.modal-title').html('View role');
            $('.modal-body').html(res);
  ...
  function add(){
    page='<?php echo base_url(); ?>roles/add';
     $.ajax({
        type: "GET",
        url: page,
        dataType: 'html',
        success: function(res) {
            ...
            $('.modal-body').html(res);
            oper="";
            url = '<?php echo base_url(); ?>roles/add';
            $("#btn-submit").html("<button id='btnSave' type='button' class='btn btn-primary' onclick='saveData();'>Save</button>")
            $('#myModal').modal({backdrop: 'static'},'show');
        },
        error:function(request, status, error) {
            console.log("ajax call went wrong:" + request.responseText);
  ...
  function edit(roleid){
    oper="edit";
    page='<?php echo base_url(); ?>roles/edit/'+roleid;
     $.ajax({
        type: "GET",
        url: page,
        dataType: 'html',
        success: function(res) {
            ...
            $('.modal-body').html(res);
            oper="";
            url = '<?php echo base_url(); ?>roles/edit/'+roleid;
            $("#btn-submit").html("<button id='btnSave' type='button' class='btn btn-primary' onclick='saveData();'>Save</button>")
            $('#myModal').modal({backdrop: 'static'},'show');
        },
        error:function(request, status, error) {
  ...
  function deleted(roleid){
    page='<?php echo base_url(); ?>roles/delete/'+roleid;
     $.ajax({
        type: "GET",
        url: page,
        dataType: 'html',
        success: function(res) {
            ...
            $('.modal-body').html(res);
            url = '<?php echo base_url(); ?>roles/delete/'+roleid;
            oper="del";
