<form method="post" id="fmacl">
    <input type="hidden" name="useraclid" value="<?= @$data->useraclid ?>">
...
<script>
    $(document).ready(function(){
     ...
     $('#tableRoles tfoot th').each( function () {
          var title = $(this).text();
          if(title!='')
      ...
      $('#select-all').on('click', function(){
          ...
          var rows = tableRoles.rows({ 'search': 'applied' }).nodes();
          // Check/uncheck checkboxes for all rows in the table
          $('input[type="checkbox"]', rows).prop('checked', this.checked);
       });

       // Handle click on checkbox to set state of "Select all" control
       $('#tableRoles tbody').on('change', 'input[type="checkbox"]', function(){
      ...
      // tableRoles.ajax.reload( function ( json ) {
      //     if(oper!="add"){
      //           var acos = "<?= @$data->acos ?>";
      //       }
      //       var ex = acos.split(", ");
